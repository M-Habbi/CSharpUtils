...
namespace Habbi.Utils.Extensions
{
    ...
    {
        /// <summary>
        /// Compares the value of this instance to a specified <see cref="DateTime" /> value and returns an integer that indicates whether this instance is earlier than, the same as, or later than the specified <see cref="DateTime" /> value.
        /// </summary>
        /// <param name="comparer">The <see cref="DateTime" /> to be compared with.</param>
        /// <returns>A signed number indicating the relative values of this instance and the value parameter. (Less than zero: This instance is earlier than value. Zero: This instance is the same as value. Greater than zero: This instance is later than value.)</returns>
